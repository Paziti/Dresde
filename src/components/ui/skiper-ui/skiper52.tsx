...
/**
 * Installed via `pnpm dlx shadcn add @skiper-ui/skiper52` for the Dresde
 * build. The demo below is kept close to upstream for reference; the
 * production version actually used on the site is
